...
use BedrockStarter\responses\chats\ListChatMembersResponse;
use BedrockStarter\responses\framework\RouteResponse;

final class ListChatMembersRequest extends RouteBoundRequestBase
{
    ...
    {
        return new ListChatMembersResponse($bedrockResponse);
    }
}
